...
export default function ServicesThreeSection() {
  return (
    <section className="w-full px-6 md:px-12 py-16 bg-[#44BBA4] mt-16 rounded-2xl">
      <div className="container mx-auto text-center">
        <h3 className="text-4xl font-bold text-white mb-2">WHAT I DO</h3>
        <h2 className="text-3xl md:text-2xl font-serif mb-12 text-white ">
          If it needs words, it needs me
        </h2>
        <div className="flex flex-col md:flex-row justify-center gap-8">
          {/* Service Card 1 */}
          <div className="bg-white border border-gray-300 rounded-lg p-6 w-full md:w-1/3 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-shadow duration-300 hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
            ...
            <button className="bg-[#44BBA4] text-white px-4 py-2 rounded-md transition-transform duration-300 transform hover:scale-105 hover:bg-[#F6F7EB] hover:text-[#44BBA4] hover:border-[#44BBA4] hover:border">
              Learn more
            </button>
          </div>
